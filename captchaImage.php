...
// custom parameters
$box_w 				= 130;			// Width of the captha box
$box_h 				= 46;			// Height of the captha box
//$font 				= 'arial.ttf';	// Used font
$font 				= 'fonts/Raleway-Regular.ttf';
$font_size 			= 18; 			// Size of the font
$font_angle 		= 0; 			// Angle of text
$font_x 			= 25; 			// Margin left
$font_y 			= 15; 			// Margin top
$color_background 	= 'black'; 		// Bakground color: black, white, green, blu, red
$color_text 		= 'red';		// Text color: 		black, white, green, blu, red
...
$black 	= ImageColorAllocate($image, 159, 209, 236);
